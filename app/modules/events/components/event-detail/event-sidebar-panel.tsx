	...
	return (
		<div className="contents lg:block lg:space-y-6">
			...
			<div className="order-3 space-y-6">
				...
				<Activity
					mode={
						!isExternalEvent && event.capacity && canRegister && !isPastEvent ? "visible" : "hidden"
					}
				>
					<div className="space-y-2 pt-3 lg:pt-6">
						<div className="flex items-center justify-between text-sm">
							<span className="text-muted-foreground">
								{event.capacity ? event.capacity - registrationCount : 0} spots left
							</span>
				...
				<div className="space-y-3">
					<div className="space-y-2">
						<Button onClick={() => onShare(event)} variant="outline" className="w-full" size="lg">
							...
							{(() => {
								...
								return (
									<Button asChild variant="outline" className="w-full" size="lg">
										<a href={event.discussion_link || ""} target="_blank" rel="noopener noreferrer">
