...
export function EventCard({ event, communitySlug, onDelete }: EventCardProps) {
  ...
  // Get registration/subscription count - use registration_count from event_registrations for both
  ...
  // Platform icon for external events
      ...
      >
          ...
          {isExternalEvent && (
            <div className="absolute top-3 right-3 z-20">
              <Badge
                variant="outline"
                className={cn(
                  'backdrop-blur-md bg-primary/10 border-primary/50',
                  'text-primary shadow-lg font-medium',
                  'transition-all duration-300 ease-out',
                  'group-hover:scale-105 group-hover:shadow-xl',
                  'group-active:scale-100 group-active:shadow-lg'
                )}
              >
                {PlatformIcon ? (
                  <PlatformIcon className="h-3 w-3 mr-1 text-primary" />
                ) : (
        ...
        <CardContent className="px-5 py-0 space-y-4 bg-gradient-to-b from-card to-card/95">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <div className="text-primary">{typeIcons[event.event_type]}</div>
            </div>
