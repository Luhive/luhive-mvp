    ...
    <div className="space-y-6">
      <section className="space-y-4">
        <p className="text-sm text-muted-foreground">
          Select when you want to send reminder emails to registered
          participants. You can choose multiple times.
        </p>
      ...
      <Accordion
        type="single"
        collapsible
        defaultValue={customMessage ? "email-message" : undefined}
        className="border-t pt-2"
      >
        <AccordionItem value="email-message" className="border-b-0">
          <AccordionTrigger className="text-base font-medium py-2 hover:no-underline">
            <div className="flex items-center gap-2">
              <SquareDashedMousePointer className="size-4" /> Customize Email
              Message
            </div>
          </AccordionTrigger>
