...
import type { Route } from "./+types/$slug.events.$eventId.verification-sent";
...
export function meta({ params }: Route.MetaArgs) {
	return [
		{ title: "Verify Your Email - Luhive" },
		{ name: "description", content: "Check your email to verify your event registration" },
	];
}

export default function EventVerificationSent() {
		...
		<div className="mt-16">
			...
			<div className="mx-auto border rounded-md border-muted max-w-md px-6 py-12">
				<div className="flex flex-col items-center text-center">
					...
					<h1 className="text-2xl font-bold mb-2">You are almost there!</h1>
					...
					<div className="w-full flex flex-col gap-3">
						<div className="grid grid-cols-2 gap-3">
							<Button asChild variant="outline">
								...
								>
									<img src={GmailIcon} className="h-3 w-4" />
									Gmail
								</a>
							</Button>
					...
					<div className="mt-6 pt-6 border-t border-border w-full">
						<div className="text-sm text-muted-foreground text-center">
							...
							<p className="mt-2">
								Want easier RSVPs?{" "}
								<Link to="/signup" className="underline hover:text-foreground font-medium">
